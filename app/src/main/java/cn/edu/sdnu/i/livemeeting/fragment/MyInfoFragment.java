...
import cn.edu.sdnu.i.livemeeting.dialog.EditGenderDialog;
import cn.edu.sdnu.i.livemeeting.dialog.EditStrProfileDialog;
import cn.edu.sdnu.i.livemeeting.profile.ProfileEdit;
import cn.edu.sdnu.i.livemeeting.profile.ProfileTextView;
import cn.edu.sdnu.i.livemeeting.info.CustomProfile;
import cn.edu.sdnu.i.livemeeting.util.ImgUtils;
import cn.edu.sdnu.i.livemeeting.relationship.ShowOwnInformationActivity;
import cn.edu.sdnu.i.livemeeting.util.PicChooserHelper;
...
public class MyInfoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        SharedPreferences sp=getActivity().getSharedPreferences("FirstLogin", Activity.MODE_PRIVATE);
    ...
    private void getSelfInfo() {
        TIMFriendshipManager.getInstance().getSelfProfile(new TIMValueCallBack<TIMUserProfile>() {
            ...
            public void onSuccess(TIMUserProfile timUserProfile) {
                ...
                preferencesUtil.doPutString("MyId",timUserProfile.getIdentifier());
    ...
    private void updateViews(TIMUserProfile timUserProfile) {
        ...
        if (TextUtils.isEmpty(faceUrl)) {
            ...
            new SharedPreferencesUtil(getContext()).doPutString("my_face_url",faceUrl);
        } else {
            ImgUtils.loadRound(faceUrl, mAvatarImg);
        }
        String name=timUserProfile.getNickName();
        mNickNameEdt.updateValue(name);
    ...
    private void setIconKey() {
        ...
        mRenzhengEdt.set(R.drawable.ic_info_renzhen, "职位", "未知");
        ...
        mGetNumsView.set(R.drawable.ic_info_get, "获得礼物数", "0");
        mSendNumsView.set(R.drawable.ic_info_send, "送出礼物数", "0");
    }
    ...
    private void findAllViews(View view) {
        ...
        mTitleSign=view.findViewById(R.id.title_sgin);
        ...
        refreshLayout=view.findViewById(R.id.my_info_refresh);
    }

    private void setListeners() {
        mAvatarImg.setOnClickListener(clickListener);
    ...
    private void showOwnformationIPage() {
        //显示个人信息面板
        Intent intent=new Intent(getActivity(), ShowOwnInformationActivity.class);
        startActivity(intent);
    }
    ...
    private void showEditLocationDialog() {
        ...
        dialog.show("地区", R.drawable.ic_info_location1, mLocationEdt.getValue());
    }
    ...
    private void showEditSignDialog() {
        ...
        dialog.show("签名", R.drawable.ic_info_sign1, mSignEdt.getValue());
    }
    ...
    private void showEditRenzhengDialog() {
        ...
        dialog.show("认证", R.drawable.ic_info_renzhen1, mRenzhengEdt.getValue());
    }
    ...
    private void showEditNickNameDialog() {
        ...
        dialog.show("昵称", R.drawable.ic_info_nickname1, mNickNameEdt.getValue());
    }
